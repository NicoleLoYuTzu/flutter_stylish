...
import '../../bloc/detail/detail_selector_cubit.dart';
...
class _DetailPageState extends State<DetailPage> {
  static final platform = MethodChannel('exampleChannel');
  ...
  Future<void> _getPlatformString() async {
    ...
    try {
      platformString = await platform.invokeMethod('getPlatformString');
  ...
  Widget build(BuildContext context) {
    print("_platformString => $_platformString");
    context
        .read<ProductContentBloc>()
        .add(ProductContentLoadEvent(productId: int.parse(widget.productId)));
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        minimumSize: const Size(double.infinity, 50), // Set the minimum size to fill the container width
                      ),
                      child: Text(
                        state.selectedCount > 0 ? "加入購物車" : "請選擇尺寸",
                        style: TextStyle(fontSize: 16),
                      ),
                    ),
                  ),
                  SizedBox(width: 10), // Add a separator between the ElevatedButton and Icon
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
...
class SizeSelector extends StatelessWidget {
  ...
  Widget _sizeCard(BuildContext context,
      ProductSize size,
      String? selectedColorCode,
      ProductSize? selectedSize,) {
    String sizeText;
